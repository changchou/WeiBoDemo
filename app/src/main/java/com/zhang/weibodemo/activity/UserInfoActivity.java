...
import com.zhang.weibodemo.widget.Pull2RefreshListView;
import com.zhang.weibodemo.widget.UnderlineIndicatorView;
...
public class UserInfoActivity extends BaseActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    private void loadUserInfo() {
        api.usersShow("", userName, new SimpleRequestListener(this, null) {
            @Override
    ...
    private void loadStatuses(final long requestPage) {
        api.statusesUser_timeline(user == null ? -1 : user.getId(),
                userName,
                requestPage,
